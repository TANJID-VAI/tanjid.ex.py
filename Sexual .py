#created by TANJID _VAI
#team name Sawya
#tottaly written by Jannat 
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
if ltx > 12:
    ...
    tag = "AM"
logo =f"""{BLUE}==============================
{BLUE}=  ====  ==      ====        =    \033[1;32m 𓆩BDCB71𓆪
{BLUE}=  ====  ==  ===  ===  =======
{BLUE}=  ====  ==  ====  ==  =======
{BLUE}=  ====  ==  ===  ===  =======      \033[1;32m 𓆩TANJID𓆪
{BLUE}=        ==      ====      ===
{BLUE}=  ====  ==  ===  ===  =======
{BLUE}=  ====  ==  ====  ==  =======      \033[1;32m 𓆩VAI𓆪
{BLUE}=  ====  ==  ===  ===  =======
{BLUE}=  ====  ==      ====  =======
==============================
\033[1;37m╔ⒽⒷⒻ═════════════════\033[1;33mBANGLADESH CYBER_71\033[1;37m══════════════ⒽⒷⒻ╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mTANJID_ VAI     \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mTANJID VAI\033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mtanjidbd71             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+8801996225443             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                     \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32mTANJID Cyber Export             \033[1;31m   │
\033[1;37m╚ⒽⒷⒻBANGLADESH CYBER_71{ HBF }\033[1;37mⒽⒷⒻ╝
\033[1;91m==========================================================
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : TANJID VAI")
    print("\t  Fb page  : BANGLADESH CYBER_71")
    print("\t  Github   : tanjidbd71")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    if f_token in my_server:
        ...
        print(" otherwise msg on this whatsapp +8801884153077 \n")
        print(" Copy your Key :",gre,f_token+_help,wit,"\n")
        os.system("xdg-open https://www.facebook.com/please.kolixa.report.my.id")
        exit()
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_TANJID_CYBER_71_TOOL.mp3")
    os.getuid
    ...
    print(f"{BLUE}══════════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}TANJID CLONE PAK  M1")
    print(f"{RED}[02] {WHITE}TANJID CLONE BD  M1")
    print(f"{RED}[03] {WHITE}TANJID FB ID")
    print(f"{RED}[04] {WHITE}TANJID WHATSAPP")
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/please.kolixa.report.my.id");xyz()
    elif hamii in ["4","04"]:
...
def password():
    ...
    if passX in ['1','01']:
        os.system("xdg-open https://www.facebook.com/profile.php?id=100077098958486/")
        password1()
    elif passX in ['2','02']:
        os.system("xdg-open https://www.facebook.com/profile.php?id=100077098958486/")
        password2()
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[TANJID 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
